...
Or, we can visualize this in terms of our own data. See if you can produce the graph below using the code example above, and your code from class last week. 
...
1. Perform **three** two-sample *t-tests* using subsets of the data. You may compare any aspects of the data that you choose. 

2. Create box and whisker plots for each of your t-tests. 

3. Submit a brief writeup that includes: 1) an explanation of which susbets of the data you chose to analyze and why, 2) state the null and alternative hypotheses, 3) report the likelihood of whether or not your sample data represent two distinct populations.

Your writeup should be in MS Word format, and submitted via email, with the file named similarly to the midterm. Your code should be your directory on the GEOG server. Due Weds Nov 6 at midnight. 
