...
par(bg = rgb(238/255,243/255,250/255), mai=c(0,0,0,6.75))
plot(load.image("images/Leaf2.PNG"),   axes=FALSE)
a <- strwrap("Write a paragraph intepreting the results of your regression analyses. Report the appropriate statistics, and create a graph with propr axis labels and that includes the regression line. ",width=70)
